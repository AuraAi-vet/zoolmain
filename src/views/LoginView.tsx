  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-white/90 backdrop-blur-2xl rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-white/50 p-8 flex flex-col items-center text-center">
        <div className="flex flex-col items-center mb-8 text-center">
          <AnimatedLogo size="xl" className="mb-8" />
          
          <h1 className="text-3xl font-extrabold tracking-tight text-slate-900 mb-2 font-display">ZooL Platform</h1>
          <p className="text-slate-500 font-medium mb-2 flex items-center justify-center gap-2">
            <Sparkles className="w-4 h-4 text-sky-500" />
            ACCUCARE Unified Network
          </p>
        </div>
          ...
          <div className="w-full space-y-4">
            {hasBiometric && (
              <button 
                ...
                className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-slate-900 border border-slate-800 rounded-2xl text-white font-bold hover:bg-slate-800 active:scale-[0.98] transition-all disabled:opacity-50 shadow-[0_4px_20px_-4px_rgba(15,23,42,0.3)]"
              >
                {isAuthenticating ? (
            ...
            <button 
              ...
              disabled={isAuthenticating}
              className={`w-full flex items-center justify-center gap-3 px-6 py-4 bg-white border border-slate-200/80 rounded-2xl text-slate-700 font-bold hover:bg-slate-50 active:scale-[0.98] transition-all disabled:opacity-50 ${!hasBiometric ? 'shadow-sm' : ''}`}
            >
              <>
